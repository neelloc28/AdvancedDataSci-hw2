...
cp_profile <- function(explainer, new_obs, var_name) {
  cpp <- predict_profile(explainer = explainer, 
                  new_observation = lending_club_training[new_obs,],
                  variables = var_name)
  cpp
  # cpp %>% 
...
cp_profile(lending_forest_explain, 4, "int_rate")

obs4 <- lending_club_training %>% 
  slice(4)
obs4

#why is it not copying it 50 times w/ different values of int_rate??
predict_profile(explainer = lending_forest_explain,
                new_observation = obs4, variables = "int_rate")
