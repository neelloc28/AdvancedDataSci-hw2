...
**I see that this blended model (which is essentially the random forest model with the best tuning parameters) has a super high accuracy and roc_auc.  There were only 11 false positives (predicting that they would pay back a loan when they actually didn't) and 0 false negatives (predicting they wouldn't pay back a loan and they actually did).**
